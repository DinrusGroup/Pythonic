...
http://bugs.cyrcyrus.org

For further details and links, read the Help files and check the IDLE home
page at

http://www.cyrcyrus.org/idle/

There is a mail list for IDLE: idle-dev@pycyrus.org.  You can join at

http://mail.cyrcyrus.org/mailman/listinfo/idle-dev
